...
<div style="display:flex; flex-direction:column; gap:12px; margin:16px 0;">
  ...
  <div style="border:1px solid #444; border-radius:8px; padding:16px 20px; background:#111;">
    <h3 style="margin:0 0 8px;">CVE-2026-8452 <span style="font-size:0.75em; font-weight:normal; color:#aaa;">Citrix NetScaler · Pre-auth RCE</span></h3>
    <p style="margin:4px 0;"><strong>设备：</strong>Citrix NetScaler ADC / Gateway</p>
    <p style="margin:4px 0;"><strong>类型：</strong>SAML 处理链路内存破坏 → Pre-auth RCE</p>
    <p style="margin:4px 0;"><strong>测试版本：</strong>nsvpx-13.1.4.43</p>
    <p style="margin:4px 0;"><strong>内容：</strong>SAML 复现 · 崩溃调试 · 调用链定位 · 任意写 · RIP 控制</p>
    <a href="{{ '/vulnerabilities/CVE/CVE-2026-8452/' | relative_url }}">→ 查看详细分析</a>
  </div>
